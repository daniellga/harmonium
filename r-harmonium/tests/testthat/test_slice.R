test_that(
  "slice works",
  {
    check_slice = function(arr, dtype) {
    ...
    check_slice(arr, HDataType$Float32)
    check_slice(arr, HDataType$Float64)
    
    arr = array(c(1+2i,3+4i,5-6i,7+8i,9-10i,10+11i,11-12i,12+13i,14+15i,16+17i,18+19i, 20+21i), c(3, 4))
    check_slice(arr, HDataType$Complex32)
    check_slice(arr, HDataType$Complex64)
  }
)
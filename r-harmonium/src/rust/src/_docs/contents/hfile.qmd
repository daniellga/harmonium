...
`decode(fpath: string, dtype: HDataType) -> HDecodedAudio` <span style="float: right;"> [source](www.globo.com/hfile.rs#L143) </span> \
...
`decode_stream(fpath: string, frames: integer, dtype: HDataType) -> HDecoderStream` <span style="float: right;"> [source](www.globo.com/hfile.rs#L197) </span> \
...
`metadata(fpath: string, metadata_type: HMetadataType) -> list` <span style="float: right;"> [source](www.globo.com/hfile.rs#L303) </span> \
...
`params(fpath: string) -> atomicvector` <span style="float: right;"> [source](www.globo.com/hfile.rs#L375) </span> \
...
`verify(fpath: string) -> string <span style="float: right;"> [source](www.globo.com/hfile.rs#L412) </span> \

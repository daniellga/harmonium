...
`fft() -> HArray` <span style="float: right;"> [source](www.globo.com/hfft.rs#L41) </span> \
...
`fft_mut()` <span style="float: right;"> [source](www.globo.com/hfft.rs#L76) </span> \
...
`ifft() -> HArray` <span style="float: right;"> [source](www.globo.com/hfft.rs#L112) </span> \
...
`ifft_mut() -> HArray` <span style="float: right;"> [source](www.globo.com/hfft.rs#L147) </span> \
...
`rfft_mut()` <span style="float: right;"> [source](www.globo.com/hfft.rs#L187) </span> \
...
`irfft_mut(length: integer)` <span style="float: right;"> [source](www.globo.com/hfft.rs#L235) </span> \

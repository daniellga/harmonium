...
`harray() -> HArray` <span style="float: right;"> [source](www.globo.com/hfile.rs#L46) </span> \
...
`sr() -> integer` <span style="float: right;"> [source](www.globo.com/hfile.rs#L74) </span> \
...
`invalidate()` <span style="float: right;"> [source](www.globo.com/hfile.rs#L104) </span> \

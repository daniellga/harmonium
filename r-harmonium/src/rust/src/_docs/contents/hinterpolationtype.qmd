...
`print()` <span style="float: right;"> [source](www.globo.com/hinterpolationtype.rs#L42) </span> \
...
`eq(other: HInterpolationType) -> bool` <span style="float: right;"> [source](www.globo.com/hinterpolationtype.rs#L77) </span> \
...
`ne(other: HInterpolationType) -> bool` <span style="float: right;"> [source](www.globo.com/hinterpolationtype.rs#L113) </span> \

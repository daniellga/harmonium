...
`nchannels() -> integer` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L44) </span> \
...
`nframes() -> integer` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L75) </span> \
...
`db_to_amplitude(harray: HArray, reference: double)` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L111) </span> \
...
`to_mono(harray: HArray)` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L143) </span> \

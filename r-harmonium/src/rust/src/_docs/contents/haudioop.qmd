...
`nchannels() -> integer` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L43) </span> \
...
`nframes() -> integer` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L73) </span> \
...
`db_to_amplitude(harray: HArray, reference: double)` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L108) </span> \
...
`to_mono(harray: HArray)` <span style="float: right;"> [source](www.globo.com/haudioop.rs#L139) </span> \

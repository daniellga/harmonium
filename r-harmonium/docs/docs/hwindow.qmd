...
`barthann(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L48) </span> \
...
`bartlett(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L109) </span> \
...
`blackman(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L186) </span> \
...
`blackmanharris(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L242) </span> \
...
`bohman(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L298) </span> \
...
`boxcar(npoints: integer, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L349) </span> \
...
`cosine(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L399) </span> \
...
`hann(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hwindow.rs#L460) </span> \

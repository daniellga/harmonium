...
`barthann(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L47) </span> \
...
`bartlett(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L106) </span> \
...
`blackman(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L181) </span> \
...
`blackmanharris(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L235) </span> \
...
`bohman(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L291) </span> \
...
`boxcar(npoints: integer, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L340) </span> \
...
`cosine(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L388) </span> \
...
`hann(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./hwindow.rs#L447) </span> \

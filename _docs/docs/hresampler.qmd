...
`process(harray: HArray)` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L469) </span> \
...
`set_resample_ratio(new_ratio: double, ramp: bool)` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L501) </span> \
...
`set_resample_ratio_relative(rel_ratio: double, ramp: bool)` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L537) </span> \
...
`reset()` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L570) </span> \
...
`res_type() -> HResamplerType` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L604) </span> \
...
`dtype() -> HDataType` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L638) </span> \
...
`print()` <span style="float: right;"> [source](https://www.github.com/daniellga/harmonium/blob/master/r-harmonium/src/rust/src/./rust/src/hresampler.rs#L672) </span> \

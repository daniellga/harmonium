...
`decode(fpath: string, dtype: HDataType) -> HDecodedAudio`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hfile.rs#L167) </span> \
...
`decode_stream(fpath: string, frames: integer, dtype: HDataType) -> HDecoderStream`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hfile.rs#L225) </span> \

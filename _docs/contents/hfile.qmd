...
`metadata(fpath: string, metadata_type: HMetadataType) -> list<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hfile.rs#L355) </span> \
...
`params(fpath: string) -> atomicvector` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hfile.rs#L427) </span> \
...
`verify(fpath: string) -> string <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hfile.rs#L464) </span> \

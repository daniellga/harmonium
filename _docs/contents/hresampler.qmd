...
`new_fft(sr_in: integer, sr_out: integer, chunk_size: integer, sub_chunks: integer, nbr_channels: integer, res_type: HResamplerType, dtype: HDataType) -> HResampler` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L118) </span> \
...
`new_sinc(resample_ratio: double, max_resample_ratio_relative: double, parameters: HSincInterpolationParameters, chunk_size: integer, nchannels: integer, res_type: HResamplerType, dtype: HDataType) -> HResampler` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L258) </span> \
...
`new_sinc(resample_ratio: double, max_resample_ratio_relative: double, pol_deg: HPolynomialDegree, chunk_size: integer, nchannels: integer, res_type: HResamplerType, dtype: HDataType) -> HResampler` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L388) </span> \
...
`process(harray: HArray)` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L475) </span> \
...
`set_resample_ratio(new_ratio: double, ramp: bool)` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L507) </span> \
...
`set_resample_ratio_relative(rel_ratio: double, ramp: bool)` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L542) </span> \
...
`reset()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L574) </span> \
...
`res_type() -> HResamplerType` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L609) </span> \
...
`dtype() -> HDataType` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L643) </span> \
...
`print()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hresampler.rs#L677) </span> \

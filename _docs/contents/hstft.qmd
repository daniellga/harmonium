...
`new_forward(length: integer, dtype: HDataType) -> HStft`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L72) </span> \
...
`new_real_forward(length: integer, dtype: HDataType) -> HStft`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L119) </span> \
...
`process(harray: HArray, hop_length: Integer, window_length: Integer, window: Optional<HArray>)`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L190) </span> \
...
`dtype() -> HDataType`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L231) </span> \
...
`print()`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L258) </span> \
...
`clone() -> HStft`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L289) </span> \
...
`is_unique() -> bool`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L321) </span> \
...
`invalidate()`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hstft.rs#L347) </span> \

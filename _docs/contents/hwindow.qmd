...
`barthann(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L48) </span> \
...
`bartlett(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L111) </span> \
...
`blackman(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L191) </span> \
...
`blackmanharris(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L250) </span> \
...
`bohman(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L309) </span> \
...
`boxcar(npoints: integer, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L363) </span> \
...
`cosine(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L414) </span> \
...
`hann(npoints: integer, sym: bool, dtype: HDataType) -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindow.rs#L478) </span> \

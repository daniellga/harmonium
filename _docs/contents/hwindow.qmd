...
`barthann(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L57) </span> \
...
`bartlett(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L129) </span> \
...
`blackman(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L218) </span> \
...
`blackmanharris(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L286) </span> \
...
`bohman(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L354) </span> \
...
`boxcar(npoints: integer, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L413) </span> \
...
`cosine(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L473) </span> \
...
`hann(npoints: integer, sym: bool, dtype: HDataType) -> HArray`<span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium/src/rust/src/hwindow.rs#L546) </span> \

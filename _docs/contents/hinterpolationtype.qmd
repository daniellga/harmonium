...
`print()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hinterpolationtype.rs#L41) </span> \
...
`eq(other: HInterpolationType) -> bool` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hinterpolationtype.rs#L75) </span> \
...
`ne(other: HInterpolationType) -> bool` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hinterpolationtype.rs#L110) </span> \

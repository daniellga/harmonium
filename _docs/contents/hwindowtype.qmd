...
`print()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindowtype.rs#L43) </span> \
...
`eq(other: HWindowType) -> bool` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindowtype.rs#L77) </span> \
...
`ne(other: HWindowType) -> bool` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hwindowtype.rs#L112) </span> \

...
`print()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hpolynomialdegree.rs#L57) </span> \
...
`eq(other: HPolynomialDegree) -> bool` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hpolynomialdegree.rs#L91) </span> \
...
`ne(other: HPolynomialDegree) -> bool` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hpolynomialdegree.rs#L126) </span> \

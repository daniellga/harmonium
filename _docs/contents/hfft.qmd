...
`fft() -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hfft.rs#L40) </span> \
...
`fft_mut()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hfft.rs#L72) </span> \
...
`ifft() -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hfft.rs#L107) </span> \
...
`ifft_mut() -> HArray` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hfft.rs#L141) </span> \
...
`rfft_mut()` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hfft.rs#L180) </span> \
...
`irfft_mut(length: integer)` <span style="float: right;"> [source](https://github.com/daniellga/harmonium/tree/master/r-harmonium//hfft.rs#L225) </span> \
